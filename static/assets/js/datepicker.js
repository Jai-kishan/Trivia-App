...
Calendar.prototype.show = function() {
    ...
    this.wwrite("<A HREF=\"" +
        ...
        ");" +
        "\"><FONT FACE='" + fontface + "' SIZE=1><<</font><\/A></TD><TD ALIGN=center>");
    this.wwrite("<A HREF=\"" +
        "javascript:window.opener.Build(" +
    ...
    this.wwrite("<A HREF=\"" +
        ...
        "'" + this.gReturnItem + "', '" + this.gMonth + "', '" + (parseInt(this.gYear)+1) + "', '" + this.gFormat + "'" +
        ");" +
        "\"><FONT FACE='" + fontface + "' SIZE=1>>></font><\/A></TD></TR></TABLE><BR>");
...
Calendar.prototype.cal_header = function() {
    ...
    vCode = vCode + "<TD WIDTH='16%'><FONT SIZE='2' FACE='" + fontface + "' COLOR='" + this.gHeaderColor + "'><B>Fri</B></FONT></TD>";
